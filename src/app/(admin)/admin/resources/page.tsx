    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Coming soon — this page will be a repository for various kinds of
          resources.
        </p>
      </div>
      ...
      <div className="bg-card rounded-lg border p-12 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-lg font-semibold text-nmh-gray mb-2">
          Resources Hub
        </h2>
        <p className="text-muted-foreground text-sm max-w-md">
          This section will house training materials, protocol documents,
          reference links, and other resources for the EMS team. Check back
          soon!
        </p>
      </div>
    </div>
