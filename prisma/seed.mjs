...
function computeValue(month, range, genOptions) {
  ...
  let value;
  if (trendStrength < 0) {
    value = generateValue(month, range.min, range.max, {
      ...genOptions,
...
const departmentDefs = [
  {
    name: "Ambulance Services Quality",
    slug: "ambulance-services-quality",
    type: "quality",
    description:
      "Quality assurance and performance improvement for North Memorial Health ambulance operations",
    sortOrder: 1,
    divisions: [],
  },
  {
    name: "Ambulance Services Clinical Development",
    slug: "ambulance-services-clinical-development",
    type: "clinical",
    description:
      "Clinical skills development, continuing education, and competency management for field crews",
    sortOrder: 2,
    divisions: [],
  },
  {
    name: "EMS Professional Education",
    slug: "ems-professional-education",
    type: "education",
    description:
      "Initial and continuing EMS education programs including Paramedic and EMT certification courses",
    sortOrder: 3,
    divisions: [],
  },
  {
    name: "Clinical and Operational Metrics",
    slug: "clinical-and-operational-metrics",
    type: "operations",
    description:
      "Clinical performance and operational metrics across all North Memorial Health ambulance service lines",
    sortOrder: 4,
    divisions: [
      {
        name: "Air Care Clinical",
        individuals: ["AC 1", "AC 2", "AC 3", "AC 4", "AC 5", "AC 6", "AC 7"],
      },
...
const qualityMetrics = [
  {
    ...
    target: null,
    range: { min: 40, max: 80 },
    genOptions: { trendStrength: 0.3, seasonalAmplitude: 0.15, seasonalPeak: 10, decimals: 0 },
    dataDefinition:
      "Total number of patient care reports reviewed by the quality improvement team during the reporting period.",
    methodology:
      "Cases are selected via stratified random sampling plus all cases flagged by clinical triggers.",
  },
  {
    name: "Clinical Debriefs Completed",
    unit: "count",
    chartType: "bar",
    isKpi: true,
    category: "Review Activity",
    target: null,
    range: { min: 8, max: 20 },
    genOptions: { trendStrength: 0.25, seasonalAmplitude: 0.15, seasonalPeak: 10, decimals: 0 },
  },
  {
  ...
  },
  {
    ...
    target: 8,
    range: { min: 6, max: 9 },
    genOptions: { trendStrength: -0.2, seasonalAmplitude: 0.15, seasonalPeak: 1, decimals: 1 },
  },
  {
    name: "Protocol Compliance Rate",
    unit: "percentage",
    chartType: "line",
    isKpi: true,
    category: "Clinical Outcomes",
  ...
  },
  {
    ...
    target: 90,
    range: { min: 55, max: 95 },
    genOptions: { trendStrength: -0.25, seasonalAmplitude: 0.1, seasonalPeak: 1, decimals: 0 },
  },
  {
    name: "Airway Success Rate",
    unit: "percentage",
    chartType: "line",
    isKpi: false,
    category: "Clinical Outcomes",
  ...
  },
  {
    ...
    target: null,
    range: { min: 2, max: 12 },
    genOptions: { trendStrength: -0.2, seasonalAmplitude: 0.15, seasonalPeak: 7, decimals: 0 },
  },
  {
    ...
    target: null,
    range: { min: 5, max: 20 },
    genOptions: { trendStrength: 0.2, seasonalAmplitude: 0.1, seasonalPeak: 10, decimals: 0 },
  },
];

const clinicalDevMetrics = [
  {
    name: "Skills Competency Assessments",
    unit: "count",
    chartType: "bar",
    isKpi: true,
    category: "Competency",
    target: null,
    range: { min: 30, max: 65 },
    genOptions: { trendStrength: 0.3, seasonalAmplitude: 0.2, seasonalPeak: 3, decimals: 0 },
  },
  {
    name: "Field Training Hours",
    unit: "count",
    chartType: "bar",
    isKpi: true,
    category: "Training",
    ...
    genOptions: { trendStrength: 0.2, seasonalAmplitude: 0.15, seasonalPeak: 4, decimals: 0 },
  },
  {
    name: "Simulation Lab Sessions",
    unit: "count",
    chartType: "bar",
    isKpi: true,
    category: "Training",
    target: null,
    range: { min: 8, max: 18 },
    genOptions: { trendStrength: 0.25, seasonalAmplitude: 0.2, seasonalPeak: 3, decimals: 0 },
  },
  {
    name: "CE Credits Delivered",
    unit: "count",
    chartType: "line",
    isKpi: true,
    category: "Education",
    ...
    genOptions: { trendStrength: 0.2, seasonalAmplitude: 0.15, seasonalPeak: 10, decimals: 0 },
  },
  {
    name: "Competency Pass Rate",
    unit: "percentage",
    chartType: "line",
    isKpi: true,
    category: "Competency",
  ...
  },
  {
    ...
    target: null,
    range: { min: 12, max: 30 },
    genOptions: { trendStrength: 0.2, seasonalAmplitude: 0.15, seasonalPeak: 5, decimals: 0 },
  },
  {
    name: "New Protocol Rollout Compliance",
    unit: "percentage",
    chartType: "line",
    isKpi: false,
    category: "Compliance",
  ...
  },
  {
    ...
    genOptions: { trendStrength: 0.15, seasonalAmplitude: 0.2, seasonalPeak: 5, decimals: 0 },
  },
  {
    name: "High-Acuity Scenario Completions",
    unit: "count",
    chartType: "bar",
    isKpi: true,
    category: "Training",
    target: null,
    range: { min: 15, max: 40 },
    genOptions: { trendStrength: 0.3, seasonalAmplitude: 0.15, seasonalPeak: 3, decimals: 0 },
  },
];

const educationMetrics = [
  {
    name: "Progress Toward Revenue Targets",
    unit: "percentage",
    chartType: "line",
    isKpi: true,
    category: "Financial",
  ...
  },
  {
    ...
    target: null,
    range: { min: 25, max: 60 },
    genOptions: { trendStrength: 0.2, seasonalAmplitude: 0.25, seasonalPeak: 9, decimals: 0 },
  },
  {
  ...
  },
  {
    ...
    category: "Experience",
    target: 4.0,
    range: { min: 3.2, max: 4.8 },
    genOptions: { trendStrength: 0.2, seasonalAmplitude: 0.1, seasonalPeak: 6, decimals: 1 },
  },
  {
    name: "Clinical Site Placements",
    unit: "count",
    chartType: "bar",
    isKpi: false,
    category: "Clinical",
    target: null,
    range: { min: 10, max: 30 },
    genOptions: { trendStrength: 0.15, seasonalAmplitude: 0.2, seasonalPeak: 9, decimals: 0 },
  },
  {
    name: "Instructor Contact Hours",
    unit: "count",
    chartType: "bar",
    isKpi: false,
    category: "Staffing",
    ...
    genOptions: { trendStrength: 0.1, seasonalAmplitude: 0.2, seasonalPeak: 10, decimals: 0 },
  },
];
...
const operationsMetrics = [
  {
    ...
    category: "Volume",
    target: null,
    range: { min: 2000, max: 4500 },
    genOptions: { trendStrength: 0.15, seasonalAmplitude: 0.1, seasonalPeak: 7, decimals: 0 },
  },
  {
    name: "Average Response Time",
    unit: "duration",
    ...
    category: "Response",
    target: 8,
    range: { min: 5.5, max: 9.5 },
    genOptions: { trendStrength: -0.2, seasonalAmplitude: 0.12, seasonalPeak: 1, decimals: 1 },
  },
  {
  ...
  },
  {
    ...
    target: 15,
    range: { min: 12, max: 20 },
    genOptions: { trendStrength: -0.1, seasonalAmplitude: 0.08, seasonalPeak: 1, decimals: 1 },
  },
  {
    name: "Mutual Aid Given",
    unit: "count",
    chartType: "bar",
    isKpi: true,
    category: "Mutual Aid",
    target: null,
    range: { min: 10, max: 40 },
    genOptions: { trendStrength: 0.1, seasonalAmplitude: 0.15, seasonalPeak: 7, decimals: 0 },
  },
  {
    name: "Mutual Aid Received",
    unit: "count",
    chartType: "bar",
    isKpi: false,
    category: "Mutual Aid",
  ...
  },
  {
    ...
    genOptions: { trendStrength: -0.15, seasonalAmplitude: 0.1, seasonalPeak: 1, decimals: 1 },
  },
  {
    name: "Late Calls",
    unit: "count",
    ...
    target: null,
    range: { min: 5, max: 30 },
    genOptions: { trendStrength: -0.2, seasonalAmplitude: 0.1, seasonalPeak: 7, decimals: 0 },
  },
  {
    name: "Turnover Rate",
    unit: "percentage",
  ...
  {
    name: "Vehicle Out-of-Service Hours",
    unit: "count",
    chartType: "bar",
    isKpi: false,
    category: "Fleet",
    ...
    genOptions: { trendStrength: -0.15, seasonalAmplitude: 0.1, seasonalPeak: 1, decimals: 0 },
  },
  {
    name: "Dry Runs",
    unit: "count",
    ...
    genOptions: { trendStrength: 0.05, seasonalAmplitude: 0.1, seasonalPeak: 7, decimals: 0 },
  },
  {
    name: "Average Transport Time",
    unit: "duration",
    chartType: "line",
    isKpi: false,
    category: "Response",
    target: 20,
    range: { min: 14, max: 28 },
    genOptions: { trendStrength: -0.05, seasonalAmplitude: 0.08, seasonalPeak: 1, decimals: 1 },
  },
];
...
const airCareUnitRanges = {
  "Total Calls": { min: 30, max: 80 },
  "Average Response Time": { min: 8, max: 18 },
  "Unit Hour Utilization": { min: 15, max: 35 },
  "Transport Count": { min: 25, max: 65 },
  "Average On-Scene Time": { min: 14, max: 22 },
  "Mutual Aid Given": { min: 2, max: 10 },
  "Mutual Aid Received": { min: 0, max: 5 },
  "Chute Time": { min: 3, max: 8 },
  "Late Calls": { min: 0, max: 5 },
  "Turnover Rate": { min: 3, max: 12 },
  "Overtime Hours": { min: 10, max: 40 },
  "Vehicle Out-of-Service Hours": { min: 2, max: 15 },
  "Dry Runs": { min: 3, max: 15 },
  "Average Transport Time": { min: 20, max: 45 },
};
const groundBaseRanges = {
  "Total Calls": { min: 50, max: 400 },
  "Average Response Time": { min: 4, max: 12 },
  "Unit Hour Utilization": { min: 15, max: 50 },
  "Transport Count": { min: 40, max: 320 },
  "Average On-Scene Time": { min: 10, max: 20 },
  "Mutual Aid Given": { min: 1, max: 8 },
  "Mutual Aid Received": { min: 0, max: 6 },
  "Chute Time": { min: 0.8, max: 3.5 },
  "Late Calls": { min: 0, max: 10 },
  "Turnover Rate": { min: 3, max: 20 },
  "Overtime Hours": { min: 8, max: 50 },
  "Vehicle Out-of-Service Hours": { min: 1, max: 12 },
  "Dry Runs": { min: 2, max: 20 },
  "Average Transport Time": { min: 10, max: 30 },
};
...
async function main() {
  ...
  for (const dept of departmentDefs) {
    const c = await prisma.department.create({
      data: {
        name: dept.name,
        slug: dept.slug,
        type: dept.type,
  ...
  for (const dept of departmentDefs) {
    ...
    for (let i = 0; i < dept.divisions.length; i++) {
      ...
      const div = await prisma.division.create({
        data: { departmentId, name: dd.name, slug: ds, sortOrder: i + 1, isActive: true },
      });
      divisionIds[`${dept.slug}/${ds}`] = div.id;
      if (dd.individuals?.length > 0) {
        for (const iName of dd.individuals) {
          const ind = await prisma.region.create({
            data: {
              divisionId: div.id,
              name: iName,
              role:
                dd.name === "Air Care Clinical"
                  ? "Helicopter Unit"
                  : dd.name === "Ancillary Services"
                    ? "Support Unit"
                    : "Base Station",
              isActive: true,
            },
  ...
  await prisma.user.create({
    data: {
      email: "karen.wright@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Karen",
      lastName: "Wright",
      role: "manager",
  ...
  const sup1 = await prisma.user.create({
    data: {
      email: "marcus.johnson@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Marcus",
      lastName: "Johnson",
      role: "supervisor",
  ...
  // --- FTOs ---
  const fto1 = await prisma.user.create({
    data: {
      email: "rachel.nguyen@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Rachel",
      lastName: "Nguyen",
      role: "fto",
  ...
  const fto2 = await prisma.user.create({
    data: {
      email: "brian.kowalski@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Brian",
      lastName: "Kowalski",
      role: "fto",
  ...
  const fto3 = await prisma.user.create({
    data: {
      email: "samantha.lee@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Samantha",
      lastName: "Lee",
      role: "fto",
  ...
  const fto4 = await prisma.user.create({
    data: {
      email: "tyler.anderson@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Tyler",
      lastName: "Anderson",
      role: "fto",
  ...
  const fto5 = await prisma.user.create({
    data: {
      email: "natalie.brooks@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Natalie",
      lastName: "Brooks",
      role: "fto",
  ...
  const fto6 = await prisma.user.create({
    data: {
      email: "kevin.russo@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Kevin",
      lastName: "Russo",
      role: "fto",
  ...
  const fto7 = await prisma.user.create({
    data: {
      email: "amanda.foster@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Amanda",
      lastName: "Foster",
      role: "fto",
  ...
  const fto8 = await prisma.user.create({
    data: {
      email: "jason.murphy@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Jason",
      lastName: "Murphy",
      role: "fto",
  ...
  console.log(
    "  FTOs: rachel.nguyen, brian.kowalski, samantha.lee, tyler.anderson, natalie.brooks, kevin.russo, amanda.foster, jason.murphy"
  );

  // --- Trainees ---
  const trainee1 = await prisma.user.create({
    data: {
      email: "alex.chen@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Alex",
      lastName: "Chen",
      role: "trainee",
  ...
  const trainee2 = await prisma.user.create({
    data: {
      email: "jordan.williams@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Jordan",
      lastName: "Williams",
      role: "trainee",
      ...
      employeeId: "TR-002",
      divisionId: groundAmbDivId,
      hireDate: seedDate(0, 1),
      startDate: seedDate(0, 15),
      traineeStatus: "active",
    },
  });
  const trainee3 = await prisma.user.create({
    data: {
      email: "megan.taylor@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Megan",
      lastName: "Taylor",
      role: "trainee",
      ...
      employeeId: "TR-003",
      divisionId: groundAmbDivId,
      hireDate: seedDate(2, 1),
      startDate: seedDate(3, 1),
      traineeStatus: "active",
    },
  });
  const trainee4 = await prisma.user.create({
    data: {
      email: "ryan.patel@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Ryan",
      lastName: "Patel",
      role: "trainee",
      ...
      employeeId: "TR-004",
      divisionId: groundAmbDivId,
      hireDate: seedDate(4, 10),
      startDate: seedDate(5, 1),
      traineeStatus: "active",
    },
  });
  const trainee5 = await prisma.user.create({
    data: {
      email: "hannah.brown@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Hannah",
      lastName: "Brown",
      role: "trainee",
      ...
      employeeId: "TR-005",
      divisionId: airCareDivId,
      hireDate: seedDate(6, 1),
      startDate: seedDate(7, 1),
      traineeStatus: "active",
    },
  });
  const trainee6 = await prisma.user.create({
    data: {
      email: "ethan.davis@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Ethan",
      lastName: "Davis",
      role: "trainee",
      ...
      employeeId: "TR-006",
      divisionId: groundAmbDivId,
      hireDate: seedDate(8, 1),
      startDate: seedDate(9, 1),
      traineeStatus: "active",
    },
  });
  const trainee7 = await prisma.user.create({
    data: {
      email: "olivia.moore@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Olivia",
      lastName: "Moore",
      role: "trainee",
      ...
      employeeId: "TR-007",
      divisionId: groundAmbDivId,
      hireDate: seedDate(10, 15),
      startDate: seedDate(11, 1),
      traineeStatus: "active",
    },
  });
  const trainee8 = await prisma.user.create({
    data: {
      email: "lucas.jackson@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Lucas",
      lastName: "Jackson",
      role: "trainee",
      ...
      employeeId: "TR-008",
      divisionId: groundAmbDivId,
      hireDate: seedDate(12, 1),
      startDate: seedDate(13, 1),
      traineeStatus: "active",
    },
  });
  // Completed trainee
  const trainee9 = await prisma.user.create({
    data: {
      email: "sophia.white@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Sophia",
      lastName: "White",
      role: "trainee",
      ...
      hireDate: seedDate(0, 1),
      startDate: seedDate(0, 15),
      completionDate: seedDate(10, 1),
      traineeStatus: "completed",
    },
  });
  // Separated trainee
  const trainee10 = await prisma.user.create({
    data: {
      email: "noah.harris@nmhealth.org",
      passwordHash: seedPasswordHash,
      firstName: "Noah",
      lastName: "Harris",
      role: "trainee",
      ...
      employeeId: "TR-010",
      divisionId: groundAmbDivId,
      hireDate: seedDate(3, 1),
      startDate: seedDate(4, 1),
      traineeStatus: "separated",
      notes: "Voluntary separation — relocated out of state.",
    },
  });
  console.log(
    "  Trainees: alex.chen, jordan.williams, megan.taylor, ryan.patel, hannah.brown, ethan.davis, olivia.moore, lucas.jackson, sophia.white (completed), noah.harris (separated)"
  );
  ...
  if (clinicalDebriefsDef) {
    const omd = await prisma.metricDefinition.create({
      data: {
        departmentId: clinicalDebriefsDef.departmentId,
        parentId: clinicalDebriefsDef.id,
        name: "OMD Clinical Debrief",
        slug: "omd-clinical-debrief",
        unit: "count",
        aggregationType: "sum",
        chartType: "bar",
        isKpi: false,
        categoryLegacy: "Review Activity",
        sortOrder: 1,
        isActive: true,
      },
    });
    ...
    const qa = await prisma.metricDefinition.create({
      data: {
        departmentId: clinicalDebriefsDef.departmentId,
        parentId: clinicalDebriefsDef.id,
        name: "QA Clinical Debrief",
        slug: "qa-clinical-debrief",
        unit: "count",
        aggregationType: "sum",
        chartType: "bar",
        isKpi: false,
  ...
  const annotationData = [
    {
      metricName: "Cardiac Arrest Survival Rate",
      date: seedDate(1, 15),
      title: "Implemented Pit Crew CPR Model",
      type: "intervention",
    },
    {
      metricName: "Cardiac Arrest Survival Rate",
      date: seedDate(5, 1),
      title: "LUCAS Device Deployment",
      type: "intervention",
    },
    {
      metricName: "Protocol Compliance Rate",
      date: seedDate(2, 1),
      title: "Protocol Compliance Dashboard Launch",
      type: "intervention",
    },
    {
      metricName: "Airway Success Rate",
      date: seedDate(3, 1),
      title: "Video Laryngoscopy Training",
      type: "intervention",
    },
    {
      metricName: "Average Response Time",
      date: seedDate(4, 1),
      title: "Dynamic Deployment Model Activated",
      type: "intervention",
    },
    {
      metricName: "Total Calls",
      date: seedDate(6, 1),
      title: "Summer Volume Surge",
      type: "event",
    },
    {
      metricName: "Medication Error Rate",
      date: seedDate(7, 1),
      title: "Medication Double-Check Protocol Launched",
      type: "intervention",
    },
    {
      metricName: "Hand Hygiene Compliance",
      date: seedDate(8, 1),
      title: "Hand Hygiene Campaign Kickoff",
      type: "intervention",
    },
    {
      metricName: "NREMT First-Attempt Pass Rate",
      date: seedDate(4, 15),
      title: "New Test Prep Curriculum Launched",
      type: "intervention",
    },
    {
      metricName: "Total Calls",
      date: seedDate(12, 1),
      title: "Winter Storm — Increased Call Volume",
      type: "event",
    },
    {
      metricName: "Unit Hour Utilization",
      date: seedDate(10, 1),
      title: "Staffing Model Revised",
      type: "intervention",
    },
    {
      metricName: "Turnover Rate",
      date: seedDate(6, 15),
      title: "Retention Bonus Program Started",
      type: "intervention",
    },
  ];
  for (const ann of annotationData) {
    ...
    if (md)
      await prisma.metricAnnotation.create({
        data: { metricDefinitionId: md.id, date: ann.date, title: ann.title, type: ann.type },
      });
  }
  ...
  const resourceData = [
    {
      metricName: "Cardiac Arrest Survival Rate",
      title: "NMH Cardiac Arrest Protocol",
      url: "https://protocols.nmhealth.org/cardiac-arrest",
      type: "protocol",
      sortOrder: 1,
    },
    {
      metricName: "Protocol Compliance Rate",
      title: "NMH Clinical Protocol Library",
      url: "https://protocols.nmhealth.org/library",
      type: "protocol",
      sortOrder: 1,
    },
    {
      ...
      url: "https://protocols.nmhealth.org/airway",
      type: "protocol",
      sortOrder: 1,
    },
    {
      ...
      url: "https://protocols.nmhealth.org/medication-safety",
      type: "protocol",
      sortOrder: 1,
    },
    {
      metricName: "NREMT First-Attempt Pass Rate",
      title: "NREMT Exam Prep Resources",
      url: "https://www.nremt.org/resources",
      type: "link",
      sortOrder: 1,
    },
  ];
  for (const res of resourceData) {
    ...
    if (md)
      await prisma.metricResource.create({
        data: {
  ...
  const partyData = [
    ...
    },
    {
      ...
      email: "tom.anderson@nmhealth.org",
      sortOrder: 1,
    },
    {
      metricName: "Total Calls",
  ...
  for (const p of partyData) {
    ...
    if (md)
      await prisma.metricResponsibleParty.create({
        data: {
          metricDefinitionId: md.id,
          name: p.name,
          role: p.role,
  ...
  console.log(
    `  Created ${batchData.length} dept + ${divBatch.length} div + ${indivBatch.length} individual entries.`
  );
  ...
  const diagram = await prisma.driverDiagram.create({
    data: {
      name: "Reduce Emergency Response Time",
      slug: "reduce-emergency-response-time",
      description: "Reduce average response time to under 8 minutes.",
      status: "active",
      isActive: true,
      sortOrder: 1,
      metricDefinitionId: rtm?.id ?? null,
    },
  });
  const aim = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      type: "aim",
      text: "Reduce average response time to under 8 minutes for Priority 1 calls",
      sortOrder: 1,
    },
  });
  const pd1 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      parentId: aim.id,
      type: "primary",
      text: "Dispatch Efficiency",
      sortOrder: 1,
    },
  });
  const pd2 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      parentId: aim.id,
      type: "primary",
  ...
  const pd3 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      parentId: aim.id,
      type: "primary",
  ...
  const sd1 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      parentId: pd1.id,
      type: "secondary",
      text: "CAD System Response Time",
      sortOrder: 1,
    },
  });
  await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      parentId: pd1.id,
      type: "secondary",
      text: "Dispatcher Training",
      sortOrder: 2,
    },
  });
  await prisma.driverNode.create({
    data: {
      ...
      parentId: pd2.id,
      type: "secondary",
      text: "GPS-Based Unit Selection",
      sortOrder: 1,
    },
  });
  const sd4 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      parentId: pd2.id,
      type: "secondary",
      text: "Dynamic Posting Strategy",
      sortOrder: 2,
    },
  });
  const sd5 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      parentId: pd3.id,
      type: "secondary",
      text: "Shift Change Protocols",
      sortOrder: 1,
    },
  });
  const ci1 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      parentId: sd1.id,
      type: "changeIdea",
      text: "Implement GPS-based unit recommendation in CAD",
      sortOrder: 1,
    },
  });
  const ci4 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      parentId: sd4.id,
      type: "changeIdea",
      text: "Implement predictive posting model",
      sortOrder: 1,
    },
  });
  const ci5 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram.id,
      parentId: sd5.id,
      type: "changeIdea",
      text: "Staggered shift change with 30-minute overlap",
      sortOrder: 1,
    },
  });

  await prisma.pdsaCycle.create({
    data: {
      title: "GPS-Based Unit Recommendation Pilot",
      cycleNumber: 1,
      status: "completed",
      outcome: "adopt",
      driverDiagramId: diagram.id,
      metricDefinitionId: rtm?.id ?? null,
      changeIdeaNodeId: ci1.id,
      planDescription: "Test GPS-based unit recommendation.",
      planStartDate: seedDate(0, 5),
      doStartDate: seedDate(1, 1),
      doEndDate: seedDate(2, 1),
      studyResults: "33% improvement in dispatch-to-enroute time.",
      studyDate: seedDate(2, 15),
      actDecision: "Adopt and roll out.",
      actDate: seedDate(3, 1),
    },
  });
  await prisma.pdsaCycle.create({
    data: {
      title: "Predictive Posting Model Test",
      cycleNumber: 1,
      status: "studying",
      driverDiagramId: diagram.id,
      metricDefinitionId: rtm?.id ?? null,
      changeIdeaNodeId: ci4.id,
      planDescription: "Test predictive posting model.",
      planStartDate: seedDate(3, 10),
      doStartDate: seedDate(4, 1),
      doEndDate: seedDate(5, 15),
      studyResults: "1.3 min improvement.",
      studyDate: seedDate(6, 1),
    },
  });
  await prisma.pdsaCycle.create({
    data: {
      title: "Staggered Shift Change Pilot",
      cycleNumber: 1,
      status: "planning",
      driverDiagramId: diagram.id,
      changeIdeaNodeId: ci5.id,
      planDescription: "Test 30-min overlapping shift changes.",
      planStartDate: seedDate(8, 1),
    },
  });

  // Second driver diagram — Cardiac Arrest Survival
  const casrDef = findMetricDef("Cardiac Arrest Survival Rate");
  const diagram2 = await prisma.driverDiagram.create({
    data: {
      name: "Improve Cardiac Arrest Survival",
      slug: "improve-cardiac-arrest-survival",
      description:
        "Increase overall cardiac arrest survival to neurologically intact discharge above 15%.",
      status: "active",
      isActive: true,
      sortOrder: 2,
      metricDefinitionId: casrDef?.id ?? null,
    },
  });
  const aim2 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram2.id,
      type: "aim",
      text: "Increase cardiac arrest survival (CPC 1-2) to above 15% by end of fiscal year",
      sortOrder: 1,
    },
  });
  const ca_pd1 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram2.id,
      parentId: aim2.id,
      type: "primary",
      text: "Early Recognition & CPR Quality",
      sortOrder: 1,
    },
  });
  const ca_pd2 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram2.id,
      parentId: aim2.id,
      type: "primary",
      text: "Advanced Interventions",
      sortOrder: 2,
    },
  });
  const ca_pd3 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram2.id,
      parentId: aim2.id,
      type: "primary",
  ...
  const ca_sd1 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram2.id,
      parentId: ca_pd1.id,
      type: "secondary",
      text: "Pit Crew CPR Model",
      sortOrder: 1,
    },
  });
  await prisma.driverNode.create({
    data: {
      ...
      parentId: ca_pd1.id,
      type: "secondary",
      text: "Bystander CPR Enhancement",
      sortOrder: 2,
    },
  });
  const ca_sd3 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram2.id,
      parentId: ca_pd2.id,
      type: "secondary",
      text: "Mechanical CPR Devices",
      sortOrder: 1,
    },
  });
  await prisma.driverNode.create({
    data: {
      ...
      parentId: ca_pd2.id,
      type: "secondary",
      text: "Double Sequential Defibrillation",
      sortOrder: 2,
    },
  });
  await prisma.driverNode.create({
    data: {
      ...
      parentId: ca_pd3.id,
      type: "secondary",
      text: "Targeted Temperature Management",
      sortOrder: 1,
    },
  });
  const ca_ci1 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram2.id,
      parentId: ca_sd1.id,
      type: "changeIdea",
      text: "Quarterly high-fidelity cardiac arrest simulations",
      sortOrder: 1,
    },
  });
  const ca_ci2 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram2.id,
      parentId: ca_sd3.id,
      type: "changeIdea",
      text: "Deploy LUCAS 3 on every ALS unit",
      sortOrder: 1,
    },
  });
  ...
  await prisma.pdsaCycle.create({
    data: {
      title: "Quarterly Cardiac Arrest Simulation Program",
      cycleNumber: 1,
      status: "doing",
      driverDiagramId: diagram2.id,
      metricDefinitionId: casrDef?.id ?? null,
      changeIdeaNodeId: ca_ci1.id,
      planDescription: "Run quarterly high-fidelity simulations with all ALS crews.",
      planStartDate: seedDate(4, 1),
      doStartDate: seedDate(5, 1),
      doEndDate: seedDate(10, 30),
    },
  });
  await prisma.pdsaCycle.create({
    data: {
      title: "LUCAS 3 Deployment on ALS Units",
      cycleNumber: 1,
      status: "completed",
      outcome: "adopt",
      driverDiagramId: diagram2.id,
      metricDefinitionId: casrDef?.id ?? null,
      changeIdeaNodeId: ca_ci2.id,
      planDescription: "Deploy LUCAS 3 devices to all ALS ambulances.",
      planStartDate: seedDate(1, 1),
      doStartDate: seedDate(2, 1),
      doEndDate: seedDate(4, 1),
      studyResults: "Improved compression fraction from 72% to 89%. Survival trend improving.",
      studyDate: seedDate(4, 15),
      actDecision: "Full adoption — order 5 additional units.",
      actDate: seedDate(5, 1),
    },
  });

  // Third driver diagram — Medication Error Reduction
  const medErrDef = findMetricDef("Medication Error Rate");
  const diagram3 = await prisma.driverDiagram.create({
    data: {
      name: "Reduce Medication Errors",
      slug: "reduce-medication-errors",
      description: "Reduce medication error rate below 0.5% through system-level interventions.",
      status: "draft",
      isActive: true,
      sortOrder: 3,
      metricDefinitionId: medErrDef?.id ?? null,
    },
  });
  const aim3 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram3.id,
      type: "aim",
      text: "Reduce medication error rate to below 0.5% within 12 months",
      sortOrder: 1,
    },
  });
  const me_pd1 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram3.id,
      parentId: aim3.id,
      type: "primary",
      text: "Standardize Medication Preparation",
      sortOrder: 1,
    },
  });
  const me_pd2 = await prisma.driverNode.create({
    data: {
      driverDiagramId: diagram3.id,
      parentId: aim3.id,
      type: "primary",
      text: "Crew Education & Competency",
      sortOrder: 2,
    },
  });
  await prisma.driverNode.create({
    data: {
      ...
      parentId: me_pd1.id,
      type: "secondary",
      text: "Pre-drawn Medication Kits",
      sortOrder: 1,
    },
  });
  await prisma.driverNode.create({
    data: {
      ...
      parentId: me_pd1.id,
      type: "secondary",
      text: "Color-Coded Syringe System",
      sortOrder: 2,
    },
  });
  await prisma.driverNode.create({
  ...
  const campaign1 = await prisma.campaign.create({
    data: {
      ...
      description:
        "Comprehensive initiative to reduce emergency response times across all NMH EMS divisions through dispatch optimization, route planning, and crew readiness improvements.",
      goals:
        "- Reduce average P1 response time to under 8 minutes\n- Improve dispatch-to-enroute interval by 30%\n- Implement predictive posting in all divisions\n- Achieve 95% compliance with chute-time targets",
      status: "active",
  ...
  const campaign2 = await prisma.campaign.create({
    data: {
      ...
      description:
        "Multi-year program targeting improved cardiac arrest outcomes through crew training, equipment deployment, and protocol optimization.",
      goals:
        "- Achieve >15% neurologically intact survival rate\n- Deploy mechanical CPR on all ALS units\n- Quarterly simulation drills for all ALS crews\n- Implement double sequential defibrillation protocol",
      status: "active",
      ownerId: adminUser?.id ?? null,
      startDate: seedDate(3, 1),
      endDate: null,
  ...
  await prisma.actionItem.create({
    data: {
      ...
      description:
        "Work with IT to purchase and integrate GPS-based unit recommendation module for CAD system.",
      status: "in_progress",
      priority: "high",
  ...
  await prisma.actionItem.create({
    data: {
      ...
      description:
        "Coordinate with training division to schedule simulations for all ALS crews in Q3.",
      status: "open",
      priority: "medium",
  ...
  for (const p of phases) {
    const c = await prisma.trainingPhase.create({ data: p });
    phaseRecords[p.slug] = c.id;
  }
  ...
  for (const ec of evalCategories) {
    const c = await prisma.evaluationCategory.create({ data: ec });
    evalCatRecords[ec.slug] = c.id;
  }
  ...
  const coachingActivities = [
    ...
    },
    {
      ...
      estimatedMins: 15,
      description:
        "Interactive scenario: Communicating with an anxious patient refusing treatment.",
      content: null,
    },
    {
      categorySlug: "crew-communication",
      title: "Crew Resource Management Basics",
      type: "reading",
      difficulty: "basic",
      estimatedMins: 10,
      description: "Review CRM principles for effective crew communication.",
      content:
    ...
    {
      categorySlug: "clinical-decision-making",
      title: "Clinical Decision-Making Framework",
      type: "reading",
      difficulty: "intermediate",
      estimatedMins: 12,
      description: "Review frameworks for making better clinical decisions in the field.",
      content:
    ...
    {
      categorySlug: "scene-management",
      title: "Scene Management Principles",
      type: "reading",
      difficulty: "basic",
      estimatedMins: 8,
      description: "Review scene safety and management fundamentals.",
      content:
    ...
    {
      categorySlug: "stress-tolerance",
      title: "Stress Management for EMS",
      type: "reading",
      difficulty: "basic",
      estimatedMins: 10,
      description: "Learn strategies for managing stress in high-pressure EMS situations.",
      content:
    ...
    {
      categorySlug: "appearance-demeanor",
      title: "Professional Appearance & Conduct",
      type: "reflection",
      difficulty: "basic",
      estimatedMins: 8,
      description:
        "Reflect on how your professional appearance affects patient and crew interactions.",
      content:
    ...
    },
    {
      ...
      title: "Equipment Familiarity Checklist",
      type: "reading",
      difficulty: "basic",
      estimatedMins: 10,
      description: "Review key equipment operation and troubleshooting steps.",
      content:
    ...
    {
      categorySlug: "officer-safety",
      title: "Situational Awareness for EMS",
      type: "reading",
      difficulty: "basic",
      estimatedMins: 8,
      description: "Review situational awareness principles for scene safety.",
      content:
  ...
  for (const ca of coachingActivities) {
    ...
    if (!catId) {
      console.warn(`  Skipping coaching activity: no category for slug "${ca.categorySlug}"`);
      continue;
    }
  ...
  const skillDefs = [
    {
      category: { name: "Airway Management", slug: "airway-management", sortOrder: 1 },
      skills: [
        { name: "OPA", slug: "opa", sortOrder: 1 },
        { name: "NPA", slug: "npa", sortOrder: 2 },
        {
        ...
        { name: "Surgical Cricothyrotomy", slug: "surgical-cric", sortOrder: 5, isCritical: true },
        { name: "Suctioning", slug: "suctioning", sortOrder: 6 },
      ],
    },
    {
      category: { name: "Cardiac Care", slug: "cardiac-care", sortOrder: 2 },
      skills: [
        { name: "12-Lead ECG", slug: "12-lead-ecg", sortOrder: 1, isCritical: true },
        { name: "Cardiac Monitor", slug: "cardiac-monitor", sortOrder: 2 },
        {
          name: "Cardioversion",
          slug: "synchronized-cardioversion",
          sortOrder: 3,
          isCritical: true,
        },
        { name: "Defibrillation", slug: "defibrillation", sortOrder: 4, isCritical: true },
        { name: "TCP", slug: "tcp", sortOrder: 5, isCritical: true },
        { name: "CPR Quality", slug: "cpr-quality", sortOrder: 6 },
      ],
    },
    {
      category: { name: "Trauma Care", slug: "trauma-care", sortOrder: 3 },
      skills: [
        { name: "Spinal Motion Restriction", slug: "spinal-motion-restriction", sortOrder: 1 },
        { name: "Tourniquet", slug: "tourniquet", sortOrder: 2, isCritical: true },
        { name: "Wound Packing", slug: "wound-packing", sortOrder: 3, isCritical: true },
        { name: "Splinting", slug: "splinting", sortOrder: 4 },
        { name: "Chest Seal", slug: "chest-seal", sortOrder: 5 },
        {
          name: "Needle Thoracostomy",
          slug: "needle-thoracostomy",
          sortOrder: 6,
          isCritical: true,
        },
      ],
    ...
    {
      category: { name: "Medical Emergencies", slug: "medical-emergencies", sortOrder: 4 },
      skills: [
        { name: "Blood Glucose", slug: "blood-glucose", sortOrder: 1 },
        { name: "IV Access", slug: "iv-access", sortOrder: 2, isCritical: true },
        { name: "IO Access", slug: "io-access", sortOrder: 3, isCritical: true },
        { name: "Medication Admin", slug: "medication-admin", sortOrder: 4, isCritical: true },
        { name: "Nebulizer", slug: "nebulizer", sortOrder: 5 },
        { name: "Stroke Assessment", slug: "stroke-assessment", sortOrder: 6 },
      ],
    },
    {
      category: { name: "OB/Pediatrics", slug: "ob-pediatrics", sortOrder: 5 },
      skills: [
        { name: "Normal Delivery", slug: "normal-delivery", sortOrder: 1, isCritical: true },
        { name: "Neonatal Resus", slug: "neonatal-resus", sortOrder: 2, isCritical: true },
        { name: "Ped Assessment Triangle", slug: "ped-assessment-triangle", sortOrder: 3 },
        { name: "Ped Medication Dosing", slug: "ped-medication-dosing", sortOrder: 4 },
        { name: "Ped Airway", slug: "ped-airway", sortOrder: 5, isCritical: true },
      ],
    },
    {
      category: { name: "Driving & Operations", slug: "driving-operations", sortOrder: 6 },
      skills: [
        { name: "EVOC", slug: "evoc", sortOrder: 1, isCritical: true },
        { name: "Non-Emergency Driving", slug: "non-emergency-driving", sortOrder: 2 },
        { name: "Vehicle Inspection", slug: "vehicle-inspection", sortOrder: 3 },
        { name: "Equipment Inventory", slug: "equipment-inventory", sortOrder: 4 },
        { name: "Radio Comms", slug: "radio-comms", sortOrder: 5 },
      ],
    },
    {
      category: { name: "Administrative", slug: "administrative", sortOrder: 7 },
      skills: [
        { name: "PCR Completion", slug: "pcr-completion", sortOrder: 1 },
        { name: "Billing Documentation", slug: "billing-documentation", sortOrder: 2 },
        { name: "HIPAA Compliance", slug: "hipaa-compliance", sortOrder: 3 },
        {
          name: "Controlled Substance Docs",
          slug: "controlled-substance-docs",
          sortOrder: 4,
          isCritical: true,
        },
        { name: "Incident Reporting", slug: "incident-reporting", sortOrder: 5 },
        { name: "MCI/ICS Documentation", slug: "mci-ics-docs", sortOrder: 6 },
      ],
    },
  ];
  const skillRecords = {};
  ...
  for (const sd of skillDefs) {
    ...
    for (const sk of sd.skills) {
      ...
      const c = await prisma.skill.create({
        data: {
          categoryId: cat.id,
          name: sk.name,
          slug: sk.slug,
          isCritical: sk.isCritical || false,
  ...
  for (const ta of traineeAssignments) {
    await prisma.trainingAssignment.create({
      data: {
        traineeId: ta.trainee.id,
        ftoId: ta.fto.id,
        startDate: seedDate(ta.start, 1),
        status:
          ta.trainee === trainee9
            ? "completed"
            : ta.trainee === trainee10
              ? "reassigned"
              : "active",
      },
    });
  ...
  async function createTraineePhases(trainee, progressLevel, ftoForSignoff, startMonthIdx) {
    ...
    for (let i = 0; i < phaseList.length; i++) {
      ...
      await prisma.traineePhase.create({
        data: {
          traineeId: trainee.id,
          phaseId: phaseRecords[phaseList[i]],
          startDate: startD,
          endDate: endD,
          status,
          ftoSignoffId: signoff,
        },
      });
    }
  }
  ...
  const categoryComments = {
    "appearance-demeanor": {
      high: [
        "Professional appearance, well-groomed, uniform squared away.",
        "Sharp presentation — good first impression with patients and families.",
        "Consistently maintains professional appearance.",
        null,
      ],
      low: [
        "Needs to pay attention to uniform standards — shirt untucked on two calls.",
        "Arrived with wrinkled uniform; reviewed dress code expectations.",
        "Could be more conscious of professional image.",
        null,
      ],
    },
    "attitude-feedback": {
      high: [
        "Receptive to coaching and implements feedback immediately.",
        "Great attitude — asks thoughtful follow-up questions after feedback.",
        "Takes constructive criticism well and applies it on the next call.",
        null,
      ],
      low: [
        "Became defensive when given feedback about IV technique.",
        "Needs to be more open to coaching — argued about protocol interpretation.",
        "Resistant to feedback today; discussed importance of growth mindset.",
        null,
      ],
    },
    "knowledge-protocols": {
      high: [
        "Strong protocol knowledge — correctly identified STEMI criteria without prompting.",
        "Accurately recalled medication dosages for pediatric patient.",
        "Solid grasp of chest pain protocol and decision points.",
        null,
      ],
      low: [
        "Confused stroke protocol steps — need to review FAST assessment.",
        "Incorrectly stated dose for adenosine; scheduled pharmacology review.",
        "Needs to review altered mental status protocol — missed key steps.",
        null,
      ],
    },
    "knowledge-policies": {
      high: [
        "Good understanding of department SOPs and documentation requirements.",
        "Correctly followed MCI notification policy on a multi-patient incident.",
        null,
      ],
      low: [
        "Unfamiliar with controlled substance documentation requirements.",
        "Needs to review patient refusal policy and required documentation.",
        null,
      ],
    },
    "scene-management": {
      high: [
        "Excellent scene management on a chaotic MVC — maintained control.",
        "Great situational awareness on a domestic violence call.",
        "Solid scene size-up and good use of bystanders for crowd control.",
        null,
      ],
      low: [
        "Tunnel-visioned on patient and missed scene hazards.",
        "Needs to establish command presence earlier — scene was disorganized.",
        "Didn't request PD for a behavioral call in a sketchy area.",
        null,
      ],
    },
    "patient-assessment": {
      high: [
        "Thorough head-to-toe assessment — didn't miss the posterior rib fractures.",
        "Excellent SAMPLE/OPQRST on a chest pain patient.",
        "Identified subtle stroke symptoms that others might miss.",
        null,
      ],
      low: [
        "Missed a secondary injury on a fall patient — need to be more thorough.",
        "Assessment was rushed — didn't auscultate lung sounds on a dyspnea call.",
        "Needs to develop a systematic approach — assessment was disorganized.",
        null,
      ],
    },
    "clinical-decision-making": {
      high: [
        "Made excellent decision to bypass closer facility for STEMI center.",
        "Good clinical judgment — recognized sepsis early and initiated protocol.",
        "Appropriate use of standing orders for chest pain management.",
        null,
      ],
      low: [
        "Chose BLS transport for a patient who needed ALS intervention.",
        "Delayed medication administration due to uncertainty — discuss with medical control sooner.",
        "Struggled with treatment prioritization on a multi-system trauma.",
        null,
      ],
    },
    "patient-communication": {
      high: [
        "Excellent bedside manner with anxious pediatric patient and family.",
        "Communicated plan of care clearly — patient and family felt reassured.",
        "Great de-escalation with an agitated patient.",
        null,
      ],
      low: [
        "Used too much medical jargon — patient was confused about treatment.",
        "Needs to explain procedures before performing them.",
        "Minimal communication with patient during transport — felt impersonal.",
        null,
      ],
    },
    "crew-communication": {
      high: [
        "Clear, concise radio report to receiving facility.",
        "Great closed-loop communication during cardiac arrest.",
        "Communicated well with fire crew on scene.",
        null,
      ],
      low: [
        "Radio report was disorganized — practice SBAR format.",
        "Didn't communicate patient status changes to partner during transport.",
        "Late hospital notification on a trauma alert.",
        null,
      ],
    },
    documentation: {
      high: [
        "PCR was thorough and completed before end of shift.",
        "Excellent narrative — painted a clear clinical picture.",
        "Good use of timestamps and interventions in documentation.",
        null,
      ],
      low: [
        "PCR not completed until next day — needs to prioritize documentation.",
        "Narrative was too brief — didn't document clinical decision-making.",
        "Missing vital sign trends in documentation.",
        null,
      ],
    },
    "driving-vehicle-ops": {
      high: [
        "Smooth driving, appropriate speed, good use of mirrors.",
        "Safe emergency driving — proper intersection clearing.",
        "Good backing skills and spatial awareness.",
        null,
      ],
      low: [
        "Took corners too fast with patient in back.",
        "Needs to work on smooth braking — patient complained about rough ride.",
        "Missed a turn due to unfamiliarity with response area.",
        null,
      ],
    },
    "equipment-maintenance": {
      high: [
        "Thorough rig check — found and replaced expired medications.",
        "Good equipment familiarity — set up for RSI without prompting.",
        "Knows where everything is and keeps workspace organized.",
        null,
      ],
      low: [
        "Didn't check suction unit during rig check — it wasn't working on scene.",
        "Unfamiliar with ventilator setup — took too long on critical call.",
        "Left airway bag unrestocked after a call.",
        null,
      ],
    },
    "officer-safety": {
      high: [
        "Good scene awareness — noticed weapon in residence and repositioned.",
        "Appropriate use of PPE on every call.",
        "Maintained egress path on a volatile behavioral call.",
        null,
      ],
      low: [
        "Approached scene without staging for PD on a reported assault.",
        "Forgot gloves on a bleeding patient — reviewed BSI/PPE requirements.",
        "Positioned ambulance too close to structure fire.",
        null,
      ],
    },
    "stress-tolerance": {
      high: [
        "Remained calm and focused during a pediatric cardiac arrest.",
        "Handled a combative patient without escalating the situation.",
        "Good composure on a high-acuity shift with back-to-back calls.",
        null,
      ],
      low: [
        "Got visibly flustered during a high-acuity call — froze momentarily.",
        "Stress level affected communication with crew during critical call.",
        "Needs coping strategies for high-stress calls — discussed options.",
        null,
      ],
    },
  };
  ...
  async function generateDORs(trainee, fto, phaseSlug, startMonthIdx, count, progressionType) {
    ...
    for (let d = 0; d < count; d++) {
      ...
      const supervisorNotePool = [
        ...
        null,
        null,
        null, // most have no supervisor notes
      ];
  ...
  const alexSkills = [
    "airway-management/opa",
    "airway-management/npa",
    "airway-management/suctioning",
    "cardiac-care/cardiac-monitor",
    "cardiac-care/cpr-quality",
    "trauma-care/spinal-motion-restriction",
    "trauma-care/tourniquet",
    "trauma-care/splinting",
    "medical-emergencies/blood-glucose",
    "medical-emergencies/iv-access",
    "medical-emergencies/nebulizer",
    "driving-operations/non-emergency-driving",
    "driving-operations/vehicle-inspection",
    "driving-operations/equipment-inventory",
    "driving-operations/radio-comms",
    "administrative/pcr-completion",
    "administrative/hipaa-compliance",
  ...
  for (let i = 0; i < alexSkills.length; i++) {
    ...
    if (sid)
      await prisma.skillSignoff.create({
        data: { traineeId: trainee1.id, skillId: sid, ftoId: sup1.id, date: seedDate(2, 5 + i) },
      });
  }
  ...
  for (let i = 0; i < jordanSkills.length; i++) {
    ...
    if (sid)
      await prisma.skillSignoff.create({
        data: { traineeId: trainee2.id, skillId: sid, ftoId: fto1.id, date: seedDate(1, 3 + i) },
      });
  }
    ...
    if (sid)
      await prisma.skillSignoff.create({
        data: {
          ...
          skillId: sid,
          ftoId: fto2.id,
          date: seedDate(4, 3 + Math.floor(i / 2)),
        },
      });
  }
  ...
  for (let i = 0; i < ryanSkills.length; i++) {
    ...
    if (sid)
      await prisma.skillSignoff.create({
        data: { traineeId: trainee4.id, skillId: sid, ftoId: fto3.id, date: seedDate(6, 5 + i) },
      });
  }
  ...
  for (let i = 0; i < hannahSkills.length; i++) {
    ...
    if (sid)
      await prisma.skillSignoff.create({
        data: { traineeId: trainee5.id, skillId: sid, ftoId: fto5.id, date: seedDate(8, 3 + i) },
      });
  }
  ...
  for (let i = 0; i < ethanSkills.length; i++) {
    ...
    if (sid)
      await prisma.skillSignoff.create({
        data: { traineeId: trainee6.id, skillId: sid, ftoId: fto4.id, date: seedDate(10, 5 + i) },
      });
  }
  ...
  for (let i = 0; i < oliviaSkills.length; i++) {
    ...
    if (sid)
      await prisma.skillSignoff.create({
        data: { traineeId: trainee7.id, skillId: sid, ftoId: fto6.id, date: seedDate(12, 8 + i) },
      });
  }
  ...
  for (let i = 0; i < lucasSkills.length; i++) {
    ...
    if (sid)
      await prisma.skillSignoff.create({
        data: { traineeId: trainee8.id, skillId: sid, ftoId: fto7.id, date: seedDate(14, 5 + i) },
      });
  }
  ...
  for (let i = 0; i < allSkillKeys.length; i++) {
    ...
    if (sid)
      await prisma.skillSignoff.create({
        data: {
          traineeId: trainee9.id,
          skillId: sid,
          ftoId: fto8.id,
          date: seedDate(1 + Math.floor(i / 5), 3 + (i % 5)),
        },
      });
  }
  ...
  for (let i = 0; i < noahSkills.length; i++) {
    ...
    if (sid)
      await prisma.skillSignoff.create({
        data: { traineeId: trainee10.id, skillId: sid, ftoId: fto1.id, date: seedDate(5, 5 + i) },
      });
  }
